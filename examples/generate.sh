...
python generate.py -d examples/agreement/existential-oneshape -U -t agreement -n existential \
    -i 100 -M -H -N --v1 --config-values --world-size 100 --entity-counts [1] \
    --train-entity-counts [1] --validation-entity-counts [1] --test-entity-counts [1] \
...
python generate.py -d examples/agreement/existential -U -t agreement -n existential -i 100 -M -H \
...
python generate.py -d examples/agreement/relational-spatial -U -t agreement -n relational -i 100 \
...
python generate.py -d examples/agreement/relational -U -t agreement -n relational -i 100 -M -H -N \
...
python generate.py -d examples/agreement/quantification-count_nonsubtr -U -t agreement \
    -n quantification -i 100 -M -H -N --v1 --config-values --world-size 100 \
...
python generate.py -d examples/agreement/quantification -U -t agreement -n quantification -i 100 \
    -M -H -N --v1 --config-values --world-size 100 --captions-per-instance 5

python generate.py -d examples/agreement/quantification_complex -U -t agreement \
    -n quantification_complex -i 100 -M -H -N --v1 --config-values --world-size 100 \
    --captions-per-instance 5

# logical
python generate.py -d examples/agreement/logical-existential -U -t agreement -n logical -i 100 -M \
    -H -N --v1 --config-values --world-size 100 --collision_tolerance 0.0 \
    --captions '["existential"]' --captions-per-instance 5

python generate.py -d examples/agreement/logical -U -t agreement -n logical -i 100 -M -H -N \
    --v1 --config-values --world-size 100 --captions-per-instance 5

# classification
rm -r examples/classification

python generate.py -d examples/classification/shape-single -U -t classification -n shape -i 100 \
    -M -H -N --v1 --config-values --multi-class false

python generate.py -d examples/classification/shape-multi -U -t classification -n shape -i 100 -M \
    -H -N --v1

python generate.py -d examples/classification/shape-count -U -t classification -n shape -i 100 -M \
    -H -N --v1 --config-values --count-class true

# readme data
rm -r examples/readme

python generate.py -d examples/readme -a tar:bzip2 -t agreement -n existential -v readme -s 3,2,1 \
    -i 100 -M -T --v1

python generate.py -d examples/readme -a tar:bzip2 -t agreement -n relational -v readme -s 3,2,1 \
    -i 100 -M --v1
