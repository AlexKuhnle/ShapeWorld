...
def model(model, inputs, world_shape, cnn_size, cnn_depth, cnn_block_depth, world_reduction, caption_shape, vocabulary_size, caption_reduction, multimodal_reduction, mlp_size, mlp_depth, soft):
