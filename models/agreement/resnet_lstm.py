...
def model(model, inputs, dataset_parameters, resnet_size, resnet_depth, resnet_block_depth, world_reduction, embedding_size, caption_reduction, multimodal_reduction, mlp_size, mlp_depth, soft):
