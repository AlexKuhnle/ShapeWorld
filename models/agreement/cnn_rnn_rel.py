...
def model(model, inputs, dataset_parameters, cnn_size, cnn_depth, cnn_block_depth, embedding_size, rnn, rnn_size, caption_reduction, relnet_size, relnet_depth, relnet_relreduce, relnet_reduce, mlp_size, mlp_depth, soft):
