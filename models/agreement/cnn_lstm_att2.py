...
def model(model, inputs, dataset_parameters, cnn_size, cnn_depth, cnn_block_depth, embedding_size, caption_reduction, att_size, att_depth, mlp_size, mlp_depth, soft):
