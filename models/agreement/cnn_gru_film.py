...
def model(model, inputs, dataset_parameters, cnn_size, cnn_depth, cnn_block_depth, embedding_size, gru_size, caption_reduction, film_size, film_depth, conv_size, world_reduction, mlp_size, mlp_depth, soft):
