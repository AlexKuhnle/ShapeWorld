...
def model(model, inputs, num_classes, multi_class, class_count, world_shape, resnet_size, resnet_depth, resnet_block_depth, world_reduction, mlp_size, mlp_depth, soft):
