...
class MultiShapeDataset(ClassificationDataset):
    ...
    def get_classes(self, world):
        return set(self.world_generator.shapes.index(entity.shape) * len(self.world_generator.colors) * len(self.world_generator.textures) + self.world_generator.colors.index(entity.color) * len(self.world_generator.textures) + self.world_generator.textures.index(entity.texture) for entity in world.entities)
